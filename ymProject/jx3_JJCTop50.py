...
async def get_top200_history(typeName: str, tag: int, heiMaBang: bool):
    ...
    school_top = {}
    for i in information.all_school.keys():
        school_top[i] = 0
    print(school_top)
    failure_list = []
    for element in data.get("data")[:50]:
